...
const Footer = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#f9f9f9", color: "#333", padding: "20px 0" }}>
      {/* Main Footer Content */}
      <Box sx={{ maxWidth: "1200px", margin: "0 auto", textAlign: "center", padding: "20px" }}>
        {/* Logo and Tagline */}
        <Box sx={{ justifyContent: "center", alignItems: "center", marginBottom: "20px", gap: "10px" }}>
          <img
      ...
      <Dialog open={openContact} onClose={handleContactClose}>
        <Box sx={{ textAlign: "right", border:"none"}}>
            <Button onClick={handleContactClose} sx={{ height: "5px", width: "5px", minWidth: "auto", marginRight: "10px", marginTop:"10px", color: "black", fontSize: "1.2rem", lineHeight: "1", margin:"right"}}> 
                X 
            </Button>
        </Box>
          <DialogContent>
      ...
      <Dialog open={openAbout} onClose={handleAboutClose}>
        <DialogContent>
            <Box sx={{ textAlign: "right", border:"none"}}>
            <Button onClick={handleAboutClose} sx={{ height: "5px", width: "5px", minWidth: "auto", padding: "0", marginRight: "10px", marginTop:"10px", color: "black", fontSize: "1.2rem", lineHeight: "1", margin:"right"}}> 
                X 
            </Button>
            </Box>
          <Typography variant="body1" gutterBottom>
